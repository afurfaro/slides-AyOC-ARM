...
\begin{frame}{Solapamiento de Registros}
 \begin{textblock*}{\textwidth}(0.4cm,1.2cm) \justifying
  ...
  \begin{center} \includegraphics[width=0.5\textwidth]{VFP-Registersv2a.pdf}\end{center}}
  ...
  \begin{center} \includegraphics[width=0.5\textwidth]{VFP-Registersv2b.pdf}\end{center}}
  ...
  \begin{center} \includegraphics[width=0.5\textwidth]{VFP-Registersv3-N.pdf}\end{center}}
  ...
  \begin{center} \includegraphics[width=0.5\textwidth]{VFP-Registersv3AdvN.pdf}\end{center}}
 \end{textblock*} 
\end{frame}
