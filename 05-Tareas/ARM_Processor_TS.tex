...
\begin{frame}{Que}
 ...
 \begin{textblock*}{.5\textwidth}(0.4cm+.5\textwidth,1.2cm)
  \only<3>{\centering \includegraphics[width=0.8\textwidth]{Registers-layer1.pdf}\\}
  \only<4>{\centering \includegraphics[width=0.8\textwidth]{Registers-layer2.pdf}\\}
  \only<5>{\centering \includegraphics[width=0.8\textwidth]{Registers-layer3.pdf}\\}
  \only<6>{\centering \includegraphics[width=0.8\textwidth]{Registers-layer4.pdf}\\}
 \end{textblock*}
\end{frame}
